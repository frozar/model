  ...
  return (
    <Grid container direction="column">
      <Head>
        ...
        <meta
          property="og:title"
          content="Bringing West Coast Techology to the Midwest | Websites"
          key="og:title"
        />
      ...
      >
        ...
        <Grid item className={classes.paragraphContainer}>
          <Typography align={matchesSM ? "center" : undefined} variant="body1">
            ...
            data can reveal hidden patterns and trens in your business,
            empowering you to make smater decision with measurable effects.
          </Typography>
        </Grid>
      </Grid>
      <Grid
