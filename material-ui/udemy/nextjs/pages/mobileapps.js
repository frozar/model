    ...
    <Grid container direction="column">
      <Head>
        ...
        <meta
          name="description"
          key="description"
          content="Mobile Apps Made Easy | Our cutting-edge mobile app development process lets us build beautifully designed, carefully crafted app for both iOS and Android."
        />
        <meta
          property="og:title"
          content="Bringing West Coast Techology to the Midwest | iOS/Android App Development"
          key="og:title"
        />
        ...
        <Grid item container direction="column" className={classes.heading}>
          ...
          <Grid item>
            ...
            <Typography
              ...
              paragraph
            >
              Whether you cant an app for your customers, employees, or
        ...
        >
          ...
          <Grid item>
            <img
              ...
              style={{ maxWidth: matchesXS ? "22em" : "32em" }}
            />
          </Grid>
        </Grid>
        <Grid item container direction="column" md alignItems="center">
