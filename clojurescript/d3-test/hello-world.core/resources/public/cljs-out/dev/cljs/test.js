...
var G__9453 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__9453,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__9453;
}
});
...
var len__4531__auto___9458 = arguments.length;
var i__4532__auto___9459 = (0);
while(true){
if((i__4532__auto___9459 < len__4531__auto___9458)){
args__4534__auto__.push((arguments[i__4532__auto___9459]));

var G__9460 = (i__4532__auto___9459 + (1));
i__4532__auto___9459 = G__9460;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq9455){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9456,G__9457,seq9455__$2);
});
...
var file = cljs.core.get.call(null,map__9462__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__9462__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__9462__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__9462,map__9462__$1,file,line,column){
return (function (p1__9461_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__9461_SHARP_));
});})(map__9462,map__9462__$1,file,line,column))
...
var temp__5457__auto___9466 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9466)){
var message_9467 = temp__5457__auto___9466;
cljs.core.println.call(null,message_9467);
} else {
}
...
var G__9470__$1 = (((G__9470 == null))?null:clojure.string.split_lines.call(null,G__9470));
var G__9470__$2 = (((G__9470__$1 == null))?null:cljs.core.get.call(null,G__9470__$1,depth));
if((G__9470__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__9470__$2);
}
} else {
...
var vec__9471 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__9471,(0),null);
var column = cljs.core.nth.call(null,vec__9471,(1),null);
var vec__9474 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__9474,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__9474,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__9474,(2),null);
...
var m__$1 = (function (){var G__9477 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__9481 = (function (){var G__9480 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__9480);
} else {
return G__9480;
}
})();
...
return cljs.core.vary_meta.call(null,G__9482,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__9486 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__9486,(0),null);
var types = vec__9486;
...
return cljs.core.map.call(null,(function (p__9489){
var vec__9490 = p__9489;
var ns = cljs.core.nth.call(null,vec__9490,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__9490,(1),null);
return ((function (vec__9490,ns,vars__$1){
return (function (){
...
var G__9493 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__9493,G__9493__$1,env,once_fixtures,each_fixtures,vec__9490,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__9493,G__9493__$1,env,once_fixtures,each_fixtures,vec__9490,ns,vars__$1){
return (function (){
var seq__9494 = cljs.core.seq.call(null,vars__$1);
var chunk__9495 = null;
var count__9496 = (0);
var i__9497 = (0);
while(true){
if((i__9497 < count__9496)){
var v = cljs.core._nth.call(null,chunk__9495,i__9497);
var temp__5457__auto___9499 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___9499)){
var t_9500 = temp__5457__auto___9499;
each_fixture_fn.call(null,((function (seq__9494,chunk__9495,count__9496,i__9497,t_9500,temp__5457__auto___9499,v,each_fixture_fn,G__9493,G__9493__$1,env,once_fixtures,each_fixtures,vec__9490,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9500)));
});})(seq__9494,chunk__9495,count__9496,i__9497,t_9500,temp__5457__auto___9499,v,each_fixture_fn,G__9493,G__9493__$1,env,once_fixtures,each_fixtures,vec__9490,ns,vars__$1))
);
} else {
}


var G__9501 = seq__9494;
var G__9502 = chunk__9495;
var G__9503 = count__9496;
var G__9504 = (i__9497 + (1));
seq__9494 = G__9501;
chunk__9495 = G__9502;
count__9496 = G__9503;
i__9497 = G__9504;
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__9494);
if(temp__5457__auto__){
var seq__9494__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__9494__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__9494__$1);
var G__9505 = cljs.core.chunk_rest.call(null,seq__9494__$1);
var G__9506 = c__4351__auto__;
var G__9507 = cljs.core.count.call(null,c__4351__auto__);
var G__9508 = (0);
seq__9494 = G__9505;
chunk__9495 = G__9506;
count__9496 = G__9507;
...
var v = cljs.core.first.call(null,seq__9494__$1);
var temp__5457__auto___9509__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___9509__$1)){
var t_9510 = temp__5457__auto___9509__$1;
each_fixture_fn.call(null,((function (seq__9494,chunk__9495,count__9496,i__9497,t_9510,temp__5457__auto___9509__$1,v,seq__9494__$1,temp__5457__auto__,each_fixture_fn,G__9493,G__9493__$1,env,once_fixtures,each_fixtures,vec__9490,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9510)));
});})(seq__9494,chunk__9495,count__9496,i__9497,t_9510,temp__5457__auto___9509__$1,v,seq__9494__$1,temp__5457__auto__,each_fixture_fn,G__9493,G__9493__$1,env,once_fixtures,each_fixtures,vec__9490,ns,vars__$1))
);
} else {
}


var G__9511 = cljs.core.next.call(null,seq__9494__$1);
var G__9512 = null;
var G__9513 = (0);
var G__9514 = (0);
seq__9494 = G__9511;
...
});})(each_fixture_fn,G__9493,G__9493__$1,env,once_fixtures,each_fixtures,vec__9490,ns,vars__$1))
);
});})(each_fixture_fn,G__9493,G__9493__$1,env,once_fixtures,each_fixtures,vec__9490,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9493__$1)].join('')));

}
})());
});
;})(vec__9490,ns,vars__$1))
