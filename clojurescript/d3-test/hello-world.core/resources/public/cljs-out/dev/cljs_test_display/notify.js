...
cljs_test_display.notify.failure = (function cljs_test_display$notify$failure(p__9526){
...
var error = cljs.core.get.call(null,map__9527__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var fail = cljs.core.get.call(null,map__9527__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
return cljs_test_display.notify.with_permission.call(null,"granted",((function (map__9527,map__9527__$1,error,fail){
return (function (){
...
});})(map__9527,map__9527__$1,error,fail))
);
});
