...
var G__10815 = devtools.prefs.pref.call(null,v);
v = G__10815;
continue;
} else {
return v;
...
}catch (e10818){var _e__9832__auto__ = e10818;
return false;
}})();
...
}catch (e10822){var _e__9832__auto__ = e10822;
return false;
}})();
...
}catch (e10824){var _e__9832__auto__ = e10824;
return false;
}}
}
});
...
var vec__10826 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10826,(0),null);
var name = cljs.core.nth.call(null,vec__10826,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10829_SHARP_);
}),template);
});
